...
if($_SESSION['giaovien']){
    if (isset($_POST['signout'])) {
      ...
      unset($_SESSION['timmamon']);
      unset($_SESSION['timmaloai']);
                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    ...
                    if (isset($_POST['timbaihoc'])) {
                      $_SESSION['timmamon'] = $_POST['mamon'];
                      $_SESSION['timmaloai'] = $_POST['maloai'];
                    }
                    ?>
                    Danh sách bài giảng tìm kiếm được
                  </p>
                  <?php 
                      if (isset($_SESSION['timmamon']) && isset($_SESSION['timmaloai'])) {
                        $data_les = $db->get_list_lesson($_SESSION['timmamon'],$_SESSION['timmaloai']);
                  ?>
                  <form method="post">
                  <div class="form-group">
                    <input type="hidden" id="mamonhidden" name="mamonhidden" value="<?php echo $_SESSION['timmamon'];?>">
                    <input type="hidden" id="maloaihidden" name="maloaihidden" value="<?php echo $_SESSION['timmaloai'];?>">
