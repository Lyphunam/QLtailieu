...
<div id="myModal" class="modal">
  ...
  if (isset($_POST['changePass'])) {
    if ($_POST['pass1'] == $_POST['pass2']) {
      ...
      $newpass = $_POST['pass1'];
      if ($db->changePass($masv,$newpass) == true) {
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <div class="navbar-brand brand-logo">
          <a href="index.php?controller=user&action=sinhvien"><img src="assets/upload/images/tcu.png" alt="logo" /></a>
        </div>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center cham-ngon">
        <div>Học để biết, Học để làm, Học để cùng chung sống, Học để tự khẳng định mình.</div>
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class="count CountMessNotSeen">
                <?php 
                    $n1 = $db->getCountMessNotSeenU1($_SESSION['sinhvien']);
                    $n2 = $db->getCountMessNotSeenU2($_SESSION['sinhvien']);
                    $n = $n1 + $n2;
                  echo $n; 
                ;?>
              </span>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div id="listUserSendMess" class="preview-item-content flex-grow">
                  <h6 class="preview-subject ellipsis font-weight-medium text-dark">Danh sách người gửi
                    ...
                    <?php
                      $dataU1 = $db->getInFoUserChatU1($_SESSION['sinhvien']);
                      $namesss = $db->getNamaChatSV($_SESSION['sinhvien']);
                      ...
                      foreach($dataU1 as $key => $value)
                      {
                        ...
                        if ($namesv1['TENSV'] != "") {
                          echo '<form><p class="font-weight-light small-text listUserSendMess">'.$namesv1['TENSV'].'</p></form>';
                      ...
                      $dataU2 = $db->getInFoUserChatU2($_SESSION['sinhvien']);
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Xin chào, <?php echo $_SESSION['tensinhvien'];?></span>
              <img class="img-xs rounded-circle" src="assets/upload/images/favicon.png" alt="Profile image">
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <button id="myBtn" class="dropdown-item mt-2">Đổi Mật Khẩu</button>
            	<form method="post">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?controller=user&action=lambaitap">
              <i class="menu-icon mdi mdi-library-books"></i>
              <span class="menu-title">Làm bài tập</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?controller=user&action=nhantin">
